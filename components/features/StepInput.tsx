  ...
  return (
    <div className="max-w-2xl">
            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-sm text-green-600 mt-0.5">
                  ✓ Transcript đã lấy thành công ({transcript.split(" ").length} từ)
                </p>
              </div>
              <button
      ...
      <div className="mt-4 p-4 bg-blue-50 rounded-lg text-sm text-blue-700">
        <strong>Lưu ý:</strong> Video cần có phụ đề (captions) trên YouTube. Nếu không lấy được, bạn có thể copy transcript thủ công từ YouTube → Show transcript.
      </div>
    </div>
  );
}
